...
namespace Core
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Если хотите открыть колллекции введите - 0, если добавить коллекцию - 1, а если добавить фильм - 2");
            ...
            if(decision == 0)
            {
                ...
                Console.WriteLine("Если хотите добавить новый фильм в коллекцию - 0, а если удалить фильм из коллекции - 1");
